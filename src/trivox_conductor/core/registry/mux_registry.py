...
class MuxRegistry(ImplementationRegistry[MuxAdapter]):
    implementation_base: type = MuxAdapter
    _active: Optional[str] = None
    _active_instance: Optional[MuxAdapter] = None  # cache
    ...
    @classmethod
    def get_active_class(cls) -> Optional[Type[MuxAdapter]]:
        if cls._active is None:
            return None
        return cls._registry.get(cls._active)

    @classmethod
    def get_active(cls) -> Optional[MuxAdapter]:
        if cls._active is None:
            return None
