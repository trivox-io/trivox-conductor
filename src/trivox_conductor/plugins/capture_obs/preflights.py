...
from trivox_conductor.core.preflights.preflight_types import PreflightContext, PreflightFailure, Role
...
class ObsHealthCheck:
    ...
    adapter_name: Optional[str] = "capture_obs"   # must match OBSAdapter.meta["name"]
